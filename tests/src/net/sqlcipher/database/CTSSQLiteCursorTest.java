...
import net.sqlcipher.DataSetObserver;
 ...
 */
public class CTSSQLiteCursorTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        File databaseFile = getContext().getDatabasePath(DATABASE_FILE);
