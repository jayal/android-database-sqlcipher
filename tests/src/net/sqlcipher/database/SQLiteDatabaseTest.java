...
public class SQLiteDatabaseTest extends AndroidTestCase {
    ...
    /**
     * With sqlite's write-ahead-logging (WAL) enabled, readers get old version
     * of data from the table that a writer is modifying at the same time.
     * <p>
     ...
     * into this_table</li>
     * <li>writer stops the transaction at this point, kicks off a reader thread
     * - which will do the above SELECT query: "select count(*) from this_table"
     * </li>
     * <li>this query should return value 5 - because writer is still in
     * transaction and sqlite returns OLD version of the data</li>
     * <li>writer ends the transaction, thus making the extra row now visible to
     * everyone</li>
     * <li>reader is kicked off again to do the same query. this time query
     * should return value = 6 which includes the newly inserted row into
     * this_table.</li>
     * </p>
     * 
    ...
    private class ReaderQueryingData extends Thread {
        ...
        /**
         * constructor with a param to indicate the number of rows expected to
         * be read
         */
