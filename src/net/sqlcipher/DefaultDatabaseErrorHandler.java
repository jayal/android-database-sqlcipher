 ...
 *      net.sqlcipher.database.SQLiteDatabase.CursorFactory, DatabaseErrorHandler)}</li>
 *   <li>{@link SQLiteDatabase#openDatabase(String,
 *      net.sqlcipher.database.SQLiteDatabase.CursorFactory, int, DatabaseErrorHandler)}</li>
 * </ul>
