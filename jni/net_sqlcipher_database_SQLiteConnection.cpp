...
static JNINativeMethod sMethods[] =
{
    ...
    { "nativeClose", "(J)V",
            (void*)nativeClose },
    { "nativeRegisterCustomFunction", "(JLnet/sqlcipher/database/SQLiteCustomFunction;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "net/sqlcipher/database/SQLiteCustomFunction");
    ...
    return AndroidRuntime::registerNativeMethods(env, "net/sqlcipher/database/SQLiteConnection",
