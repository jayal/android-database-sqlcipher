...
#include "net_sqlcipher_database_SQLiteCommon.h"
...
void throw_sqlite3_exception(JNIEnv* env, int errcode,
    ...
    switch (errcode & 0xff) { /* mask off extended error code */
        ...
        case SQLITE_MISUSE:
            ...
            break;
        case SQLITE_PERM:
            exceptionClass = "net/sqlcipher/database/SQLiteAccessPermException";
            break;
        case SQLITE_BUSY:
            exceptionClass = "net/sqlcipher/database/SQLiteDatabaseLockedException";
            break;
        case SQLITE_LOCKED:
            exceptionClass = "net/sqlcipher/database/SQLiteTableLockedException";
            break;
        case SQLITE_READONLY:
            exceptionClass = "net/sqlcipher/database/SQLiteReadOnlyDatabaseException";
            break;
        case SQLITE_CANTOPEN:
            exceptionClass = "net/sqlcipher/database/SQLiteCantOpenDatabaseException";
            break;
        case SQLITE_TOOBIG:
            exceptionClass = "net/sqlcipher/database/SQLiteBlobTooBigException";
            break;
        case SQLITE_RANGE:
            exceptionClass = "net/sqlcipher/database/SQLiteBindOrColumnIndexOutOfRangeException";
            break;
        case SQLITE_NOMEM:
            exceptionClass = "net/sqlcipher/database/SQLiteOutOfMemoryException";
            break;
        case SQLITE_MISMATCH:
            exceptionClass = "net/sqlcipher/database/SQLiteDatatypeMismatchException";
            break;
