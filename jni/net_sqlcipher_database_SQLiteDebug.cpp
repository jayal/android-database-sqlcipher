...
{
    { "nativeGetPagerStats", "(Lnet/sqlcipher/database/SQLiteDebug$PagerStats;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "net/sqlcipher/database/SQLiteDebug$PagerStats");
    ...
    return AndroidRuntime::registerNativeMethods(env, "net/sqlcipher/database/SQLiteDebug",
